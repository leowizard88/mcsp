(() => {
  ...
  style.textContent = `
    .mc-account-button{position:fixed;right:24px;top:16px;z-index:9999;border:0;background:transparent;color:#050505;padding:0;cursor:pointer;filter:drop-shadow(0 4px 0 rgba(0,0,0,.20)) drop-shadow(0 0 18px rgba(255,248,214,.78)) drop-shadow(0 0 34px rgba(234,215,179,.52))}
    ...
    @media(max-width:760px){.mc-account-button{right:8px;top:8px}.mc-account-button img{width:86px;height:86px}.mc-account-name{max-width:126px;padding:8px 9px;font-size:10px}.mc-account-card{box-shadow:8px 8px 0 rgba(5,5,5,.82)}}
  `;
