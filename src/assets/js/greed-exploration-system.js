(() => {
  ...
  const render = data => {
    ...
    btn.hidden = !exp.done;
    if (exp.done) note('Il timer è finito: puoi riscuotere o vedere i risultati.'); else note('Il log mostra un evento al secondo. Scorri la barra laterale per rileggere gli eventi passati.');
