(() => {
  ...
  modal.addEventListener('click', async e => {
    ...
    try {
      ...
      render(data);
      startPolling();
    } catch (err) { modal.querySelector('[data-explore-modal-note]').textContent = err.message; }
