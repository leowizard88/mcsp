(() => {
  ...
  css.textContent = `
    .explore-modal{position:fixed;inset:0;z-index:210;display:none;align-items:center;justify-content:center;background:rgba(0,0,0,.66);backdrop-filter:blur(2px);padding:20px}.explore-modal.is-open{display:flex}.explore-card{width:min(460px,calc(100vw - var(--side,44px) - 40px));border:2px solid #dfff73;background:rgba(4,18,10,.94);box-shadow:8px 8px 0 rgba(0,0,0,.78);color:#f4ffe8;font-family:Arial,Helvetica,sans-serif;padding:18px}.explore-card h2{margin:0 0 10px;color:#ffe16a;font:900 30px/1 Impact,Haettenschweiler,'Arial Black',sans-serif;text-transform:uppercase;text-shadow:3px 3px 0 #000}.explore-card p{margin:0 0 12px;font:700 14px/1.35 Arial,Helvetica,sans-serif}.explore-choice{display:grid;grid-template-columns:1fr 1fr;gap:9px}.explore-choice button,.explore-close,.explore-results-btn,.critical-die-btn{border:1px solid #dfff73;background:rgba(22,75,0,.9);color:#dfff73;font:900 12px/1 'Courier New',monospace;text-transform:uppercase;padding:11px 10px;cursor:pointer;box-shadow:3px 3px 0 #000}.explore-choice button:hover,.explore-results-btn:hover{background:rgba(45,120,0,.92)}.explore-close{margin-top:10px;background:#222;color:#fff;border-color:#fff}.explore-log-panel{position:fixed;right:18px;top:150px;z-index:118;width:min(520px,calc(100vw - var(--side,44px) - 38px));max-height:calc(100vh - 176px);overflow:auto;border:2px solid #dfff73;background:rgba(0,7,5,.94);box-shadow:8px 8px 0 rgba(0,0,0,.75),0 0 30px rgba(120,255,60,.12);color:#f4ffe8;font-family:Arial,Helvetica,sans-serif;padding:12px;display:none}.explore-log-panel.is-open{display:block}.explore-log-panel h2{margin:0 0 6px;color:#ffe16a;font:900 28px/1 Impact,Haettenschweiler,'Arial Black',sans-serif;text-transform:uppercase;text-shadow:3px 3px 0 #000}.explore-meta{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:6px;margin:0 0 10px}.explore-meta div{border:1px solid rgba(255,255,255,.2);background:rgba(0,0,0,.36);padding:7px;font:800 12px/1.25 Arial,Helvetica,sans-serif}.explore-meta strong{display:block;color:#dfff73;font-size:10px;text-transform:uppercase}.explore-timer{font:900 28px/1 'Courier New',monospace;color:#dfff73;text-shadow:2px 2px 0 #000;margin:0 0 10px}.explore-log{display:grid;gap:5px}.explore-line{border-left:3px solid rgba(255,255,255,.25);background:rgba(255,255,255,.06);padding:6px 7px;font:700 13px/1.33 Arial,Helvetica,sans-serif}.explore-line.good{border-left-color:#66ff86;color:#baffc6}.explore-line.bad{border-left-color:#ff5a5a;color:#ffb4b4}.explore-line.system{border-left-color:#9ecbff;color:#cfe8ff}.explore-line time{opacity:.65;font-size:10px;margin-right:6px}.explore-results-btn{width:100%;margin-top:10px}.explore-note{margin:8px 0 0;color:#ffdf7b;font:800 12px/1.3 Arial,Helvetica,sans-serif}.critical-screen{position:fixed;inset:0;z-index:320;display:none;place-items:center;background:radial-gradient(circle at center,rgba(110,0,0,.92),rgba(0,0,0,.98) 62%);color:#fff;text-align:center;font-family:Arial,Helvetica,sans-serif;padding:22px}.critical-screen.is-active{display:grid}.critical-card{width:min(760px,calc(100vw - 34px));border:4px solid #ff3f3f;background:rgba(0,0,0,.74);box-shadow:0 0 0 8px #000,0 0 90px rgba(255,0,0,.42);padding:clamp(24px,5vw,52px)}.critical-card h1{margin:0 0 14px;color:#ff4747;font:900 clamp(44px,8vw,110px)/.88 Impact,Haettenschweiler,'Arial Black',sans-serif;text-transform:uppercase;text-shadow:4px 4px 0 #000}.critical-card p{margin:0 0 18px;color:#ffd0d0;font:900 16px/1.38 'Courier New',monospace;text-transform:uppercase}.critical-die-btn{background:#a50016;color:#fff;border-color:#ffd0d0;font-size:14px}.exploration-locked .map-label,.exploration-locked .location-actions button:not([data-loc-action="explore"]),.exploration-locked .side-menu button:not([data-panel="stat"]):not([data-panel="guide"]){filter:grayscale(1)!important;opacity:.46!important;pointer-events:none!important}@media(max-width:760px){.explore-log-panel{right:10px;top:96px;width:calc(100vw - var(--side,38px) - 28px);max-height:calc(100vh - 112px)}.explore-meta{grid-template-columns:1fr}.explore-choice{grid-template-columns:1fr}}
  `;
  ...
  logPanel.innerHTML = `<h2>Esplorazione</h2><div class="explore-timer" data-explore-timer>--:--</div><div class="explore-meta" data-explore-meta></div><div class="explore-log" data-explore-log></div><button type="button" class="explore-results-btn" data-explore-results hidden>Vedi risultati esplorazione</button><p class="explore-note" data-explore-note></p>`;
