(() => {
  ...
  setTimeout(async () => { try { const c = (await api()).character; currentCharacter = c; selectedLocation = c?.location || 'Shiso tree'; } catch {} }, 500);
})();
