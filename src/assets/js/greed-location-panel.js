(() => {
  ...
  const render = async (character = currentCharacter) => {
    ...
    body.innerHTML = `
      ...
      <div class="location-actions"><button type="button" data-loc-action="activity">Attività</button><button type="button" data-loc-action="rest">Riposa</button><button type="button" data-loc-action="card">Usa carta</button></div>
      <p class="location-rest-note">Riposa: energia piena, ma tutti i parametri scendono di 2 per 10 minuti.</p>
  ...
  panel.addEventListener('click', async e => {
    ...
    try {
      ...
      msg2.textContent = 'Energia ripristinata. Parametri -2 per 10 minuti.';
    } catch (err) {
